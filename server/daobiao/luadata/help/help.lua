...
◆精英怪可获得[4edaad]稀有奖励[d9ceba]。]=],
        key = "anlei_main",
        pichelp = {"pic_rukou_yuanhua_1;带指南针地区才能探索碎片掉落显示在地图下", "pic_rukou_yuanhua_2;每天0点恢复50点探索点，每次探索消耗1点", "pic_rukou_yuanhua_3;离线探索可支持30分钟，赶快开始探索吧！"},
        title = "探索提示",
    },
...
[614c32]◆[d9ceba]活动结束后，根据个人积分排名发放公会[4edaad]内部奖励[d9ceba]。
        ...
        key = "terrawar_map",
        pichelp = {"pic_rukou_yuanhua_13;初始据点都为无领主状态", "pic_rukou_yuanhua_14;点击无领主据点可查看详情及前往寻路该据点", "pic_rukou_yuanhua_17;点击无领主据点可进行占领", "pic_rukou_yuanhua_18;只需3个20级以上伙伴就可占领喵", "pic_rukou_yuanhua_15;已被占领的据点，点击可攻击", "pic_rukou_yuanhua_16;与你最强大的伙伴一起战斗吧喵！", "pic_rukou_yuanhua_19;占领三角区域还会大幅增加贡献和积分哦！"},
...
[d9ceba]◆可通过点击[4edaad]快速装备[d9ceba]快速切换核心和散件的穿戴]=],
        key = "partner_soul",
        pichelp = {"pic_rukou_yuanhua_7;点击添加御灵核心", "pic_rukou_yuanhua_8;选择相应的核心后点击确定", "pic_rukou_yuanhua_9;选择快速装备就穿戴好啦喵！", "pic_rukou_yuanhua_10;没有御灵可以点击这里前往获取！"},
        title = "伙伴御灵",
    },
