...
# gs restore 27017 
# gzip -d archivefile
# mongorestore --archive=${date_time} --username root --password bCrfAptbKeW8YoZU -d xxx
# zcat $bak_dir/${date_time}.gz | mongorestore  --username root --password bCrfAptbKeW8YoZU -d xxx
